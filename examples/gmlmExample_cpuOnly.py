...
model_structure_grp2 = pyNeuroGMLMcuda.ModelStructureGroup(num_events_grp2, max_rank_grp2, mode_dimensions_grp2, mode_parts_grp2);
...
for bb in range(num_blocks):
    ...
    for tt in range(num_trials_per_block):
        ...
        grp2= pyNeuroGMLMcuda.TrialGroup();
